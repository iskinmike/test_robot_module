...
get_some_value  | 1  | Да  | Нет  | Возвращает случайное значение в диапазоне от 1 до переданного на вход параметра - верхней границы диапазона. 
throw_exception  | 0  | Нет  | Да  | При вызове бросает исключение.
print  | 1  | Нет  | Нет  | Принимает на вход строковый параметр и выводит его в консоли.
